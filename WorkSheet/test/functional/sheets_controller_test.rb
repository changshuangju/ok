...
class SheetsControllerTest < ActionController::TestCase
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post :create, sheet: { student_name: @sheet.student_name, student_number: @sheet.student_number }
    end
  ...
  test "should update sheet" do
    put :update, id: @sheet, sheet: { student_name: @sheet.student_name, student_number: @sheet.student_number }
    assert_redirected_to sheet_path(assigns(:sheet))
  end
